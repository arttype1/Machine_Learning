...
class NeuralNetMLP(object):
    ...
    ------------------
    eval_ : dict
        Dictionary collecting the cost, traing accuracy,
        and validation accuracy for each epoch during trainging.
    """

    def __init__(self, n_hidden=30, l2=0.0, epochs=10, eta=0.001, shuffle=True, minibatch_size=1, seed=None):
    ...
    def fit(self, X_train, y_train, X_valid, y_valid):
        ...
        Parameters
        ------------------
        X_train : array, shape = [n_samples, features]
            Input Layer with original features.
        y_train : array, shape = [n_samples]
            Target class labels.
        X_valid : array, shape = [n_samples, features]
        ...
        for i in range(self.epochs):
            ...
            for start_idx in range(0, indices.shape[0] - self.minibatch_size + 1, self.minibatch_size):
                ...
                dela_w_out = (grad_w_out * self.l2 * self.w_out)
                delta_b_out = grad_b_out # bias is not regularized
                self.w_out -= self.eta * dela_w_out
